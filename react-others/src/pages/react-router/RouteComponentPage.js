/*
 * @Author: Winnie
 * @Date: 2021-04-27 14:16:18
 * @LastEditors: Winnie
 * @LastEditTime: 2021-04-27 14:24:51
 * @Description: 作用
 * @FilePath: \react-demo\src\pages\react-router\RouteComponentPage.js
 */
...
function FunctionChild(props) {
  useEffect(() => {
    console.log("useEffect-WillMount"); //sy-log
    return () => {
